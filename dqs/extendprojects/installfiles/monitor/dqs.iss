...
SetupIconFile=E:\assemble\monitor\ico\ico_128X128.ico
...
[Files]
;[64 bit files]
Source: "E:\go_workspace\src\dqs\dqs.exe"; DestDir: "{app}\server"; DestName: "dqs.exe"; Flags: ignoreversion; Components: main; Check: IsWin64
Source: "E:\go_workspace\src\dqs\socket.dll"; DestDir: "{app}\server"; DestName: "socket.dll"; Flags: ignoreversion; Components: main; Check: IsWin64
Source: "E:\go_workspace\src\dqs\ServerMgr64.exe"; DestDir: "{app}"; DestName: "ServerMgr.exe"; Flags: ignoreversion; Components: main; Check: IsWin64
Source: "E:\assemble\monitor\mongodb\mongodb64\bin\*"; DestDir: "{app}\database\bin"; Flags: ignoreversion createallsubdirs recursesubdirs; Components: database
;[32 bit files]
Source: "E:\go_workspace\src\dqs\dqs.exe"; DestDir: "{app}\server"; Flags: ignoreversion solidbreak; Components: main; Check: not IsWin64
Source: "E:\go_workspace\src\dqs\socket.dll"; DestDir: "{app}\server"; Flags: ignoreversion; Components: main; Check: not IsWin64
Source: "E:\go_workspace\src\dqs\ServerMgr.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: main; Check: not IsWin64
Source: "E:\assemble\monitor\mongodb\mongodb\bin\*"; DestDir: "{app}\database\bin"; Flags: ignoreversion createallsubdirs recursesubdirs; Components: database; Check: not IsWin64
;[32&64 bit files]
Source: "E:\go_workspace\src\dqs\seelog.xml"; DestDir: "{app}\server"; Flags: ignoreversion solidbreak; Components: main
...
Source: "E:\assemble\monitor\data\init-user.json"; DestDir: "{app}\data"; Components: database
Source: "E:\assemble\monitor\data\init-device.json"; DestDir: "{app}\data"; Components: database
Source: "E:\assemble\monitor\changelog.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: "E:\assemble\monitor\mongodb\mongodb\GNU-AGPL-3.0"; DestDir: "{app}\database"; Flags: ignoreversion; Components: database
Source: "E:\assemble\monitor\mongodb\mongodb\README"; DestDir: "{app}\database"; Flags: ignoreversion; Components: database
Source: "E:\assemble\monitor\mongodb\mongodb\THIRD-PARTY-NOTICES"; DestDir: "{app}\database"; Flags: ignoreversion; Components: database
