...
jQuery.validator.addMethod("phone", function(phone_number, element) {
	return this.optional(element) || phone_number.match(/^((0[1-9]{3})?(0[12][0-9])?[-])?\d{6,8}$/);
}, "请输入正确的电话号码");
jQuery.validator.addMethod("mobile", function(phone_number, element) {
	return this.optional(element) || phone_number.match(/(^0?[1][358][0-9]{9}$)/);
}, "请输入正确的手机号码");
jQuery.validator.addMethod("zip", function(value, element) {
	return this.optional(element) || value.match(/^[1-9]\d{5}$/);
}, "请输入正确的邮政编码");
